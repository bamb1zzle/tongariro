...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        setError('')
        // Dont want the page to be submitted every time we submit our form -> async
        try {
  ...
  return (
    <div className='w-full h-screen'>
        <img className='hidden sm:block absolute w-full h-full object-cover' src="https://images2.alphacoders.com/789/789853.jpg" alt="/" />
        {/* OVERLAY */} 
